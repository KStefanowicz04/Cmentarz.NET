...
namespace ProjektCmentarz.Controllers
{
    public class ConditionsController : Controller
    {
        ...
        public ConditionsController(GraveyardContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ConditionType")] Condition condition)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ConditionType")] Condition condition)
        {
            if (id != condition.Id)
            {
                return NotFound();
