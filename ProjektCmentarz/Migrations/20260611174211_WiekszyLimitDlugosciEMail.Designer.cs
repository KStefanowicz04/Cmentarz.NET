...
namespace ProjektCmentarz.Migrations
{
    ...
    [Migration("20260611174211_WiekszyLimitDlugosciEMail")]
    partial class WiekszyLimitDlugosciEMail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjektCmentarz.Models.Gravestone", b =>
                {
                    ...
                    b.Property<int>("GravestoneInscryptionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GravestoneInscryptionId");
            ...
            modelBuilder.Entity("ProjektCmentarz.Models.DeathCertificate", b =>
                {
                    ...
                    b.HasOne("ProjektCmentarz.Models.FuneralHome", "Issuer")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjektCmentarz.Models.Gravestone", b =>
                {
                    b.HasOne("ProjektCmentarz.Models.Grave", "Grave")
                        .WithOne("GraveGravestone")
                        .HasForeignKey("ProjektCmentarz.Models.Gravestone", "GraveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProjektCmentarz.Models.GravestoneInscryption", "GravestoneInscryption")
                        .WithMany()
                        .HasForeignKey("GravestoneInscryptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("GravestoneInscryption");
